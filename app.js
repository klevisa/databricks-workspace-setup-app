...
(function () {
  ...
  function focusNodes(ids) {
    ...
    ids.forEach(function (id) {
      if (elByNode[id]) elByNode[id].classList.remove("dim");
      else if (elByContainer[id]) elByContainer[id].classList.add("selected");   // highlight a focused frame (e.g. the control plane)
    });
  }
